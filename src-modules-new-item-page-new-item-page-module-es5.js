...
var NewItemPageComponent = /** @class */ (function () {
    function NewItemPageComponent(fb) {
        var _this = this;
        this.fb = fb;
        this.addItem = function () {
            console.log(_this.newItemForm.value);
        };
        this.isFieldValid = function (filedName) {
            return (_this.newItemForm.get(filedName).invalid &&
                _this.newItemForm.get(filedName).touched);
        };
    }
    NewItemPageComponent.prototype.ngOnInit = function () {
    ...
    NewItemPageComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=src-modules-new-item-page-new-item-page-module-es5.js.map