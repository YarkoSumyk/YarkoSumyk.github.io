...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(store, fb) {
        var _this = this;
        this.store = store;
        this.fb = fb;
        this.loginUser = function () {
            _this.store.dispatch(Object(src_store_actions_user_actions__WEBPACK_IMPORTED_MODULE_3__["login"])({
                email: _this.loginForm.value.email,
                password: _this.loginForm.value.password,
                remember: _this.loginForm.value.remember,
            }));
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(store, fb) {
        var _this = this;
        this.store = store;
        this.fb = fb;
        this.registerUser = function () {
            // console.log(this.registerForm.value);
            _this.store.dispatch(Object(src_store_actions_user_actions__WEBPACK_IMPORTED_MODULE_3__["register"])({
...
var UserService = /** @class */ (function () {
    ...
    // }
    UserService.prototype.loginUser = function (email, password, remember) {
        console.log(email, password, remember);
        console.log('Service works');
        return this.http.get(this.API_URL);
    };
    UserService.prototype.registerUser = function (firstName, lastName, email, password) {
...
var loginSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[User] Login Success'
// props<{ token: string }>()
);
var loginFailure = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[User] Login Failure');
var logout = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[User] Logout');
var register = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[User] Register', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
var registerSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[User] Register Success');
var registerFailure = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[User] Register Failure');
...
var UserEffects = /** @class */ (function () {
    function UserEffects(actions$, userService) {
        ...
        this.login$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
            return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_user_actions__WEBPACK_IMPORTED_MODULE_6__["login"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["exhaustMap"])(function (action) {
                return _this.userService
                    .loginUser(action.email, action.password, action.remember)
                    .pipe(
                // map((res) => loginSuccess(res.token))
                Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (user) { return Object(_actions_user_actions__WEBPACK_IMPORTED_MODULE_6__["loginSuccess"])(); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(Object(_actions_user_actions__WEBPACK_IMPORTED_MODULE_6__["loginFailure"])()); }));
            }
            // console.log(action)
            ));
        }
        ...
        this.register$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(function () {
            return _this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_user_actions__WEBPACK_IMPORTED_MODULE_6__["register"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["exhaustMap"])(function (action) {
                return _this.userService
                    .registerUser(action.firstName, action.lastName, action.email, action.password)
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (user) { return Object(_actions_user_actions__WEBPACK_IMPORTED_MODULE_6__["registerSuccess"])(); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(Object(_actions_user_actions__WEBPACK_IMPORTED_MODULE_6__["registerFailure"])()); }));
            }));
        });
    }
...
var loginUser = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["createReducer"])(src_store_state_user_state__WEBPACK_IMPORTED_MODULE_0__["initialUserState"], Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["on"])(src_store_actions_user_actions__WEBPACK_IMPORTED_MODULE_1__["login"], function (state) { return state; }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_2__["on"])(src_store_actions_user_actions__WEBPACK_IMPORTED_MODULE_1__["register"], function (state) { return state; })
